...
console.log(inputField)
 ...
 if (context.role !== 'admin') {
  ...
  <div>
    <h3 className="text-base sm:text-xl font-semibold">Add Accessory</h3>
  </div>
  <div role="presentation">
    <Breadcrumbs aria-label="breadcrumb" className="text-sm sm:text-base">
      ...
      <StyledBreadcrumb sx={{ cursor: "default" }} label="Add Accessory" />
    </Breadcrumbs>
  </div>
</div>
          ...
          <div className="bg-white flex flex-col gap-5 p-4">
            ...
            <div className="">
              ...
              <div className="w-full mt-6 flex gap-5 ">
                ...
                <div className=" relative w-full  h-[200px] rounded-xl  flex justify-center hover:bg-green-100 transition-all duration-300 items-center border-dashed border-gray-400 border">
                  <input
                    type="file"
                    className="w-full h-[150px] absolute  z-20 cursor-default opacity-0 outline-none "
                    id="inputBanner"
