...
console.log(inputForm)
  ...
  <div>
    <h3 className="text-base sm:text-xl font-semibold">Accessory Upload</h3>
  </div>
  <div role="presentation">
    <Breadcrumbs aria-label="breadcrumb" className="text-sm sm:text-base">
      ...
      <StyledBreadcrumb sx={{ cursor: "default" }} label="Accessory Upload" />
    </Breadcrumbs>
  </div>
</div>
    ...
    <div className="grid xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-6 mt-2 gap-4">
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="weight" placeholder="e.g. 120g" name="weight" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="material" placeholder="e.g. Plastic, Metal" name="material" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="waterResistance" placeholder="e.g. IP67" name="waterResistance" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="connectivity" placeholder="e.g. Bluetooth 5.0, Wired" name="connectivity" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="chargingTime" placeholder="e.g. 2 hours" name="chargingTime" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="backupTime" placeholder="e.g. 8 hours" name="backupTime" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        <div className="col-span-2">
            <label className="font-semibold text-[13px] text-gray-800" htmlFor="backupTime">BATTERY CAPACITY</label><br />
            <input type="text" id="backupTime" placeholder="eg. 5000mah" name="batteryCapacity" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
        ...
        <div className="col-span-2">
            ...
            <input type="text" id="warranty" placeholder="e.g. 1 Year" name="warranty" onChange={handleChange}
                className="p-3 w-full outline-none border mt-2 border-gray-400 py-4 px-5 rounded-md" />
        </div>
...
export default AddSubProdcuts;


// this is my product upload convert it into accessory upload add accessory specs and which is required i will add add keep images uplaod as it is and other fields name subcscription for category select i will add accessory selectz