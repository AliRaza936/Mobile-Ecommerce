...
let [inputField,setInputField] = useState({
    ...
    return ; // Optionally return null to prevent rendering the resource
        ...
        context.setProgress(30)
            ...
            try {
                let result = await axios.put(`${BASE_URL}/banner/update/${id}`,inputField, {
      ...
      let singleBanner  = async (id) => {
        ...
        context.setProgress(30)
            ...
            try {
                let result = await axios.get(`${BASE_URL}/banner/single/${id}`,inputField, {
                    withCredentials: true,
                    headers: {
                        "Content-Type": "multipart/form-data",
                    },
  ...
  return (
       <div className=" p-3">
         <div className="w-full flex justify-between p-5 rounded-lg bg-white">
              <div>
                <h3 className="text-xl font-semibold">Banner Update</h3>
              </div>
