...
let [inputField,setInputField] = useState({
    ...
    return ; // Optionally return null to prevent rendering the resource
        ...
        context.setProgress(30)
            ...
            try {
                let result = await axios.put(`${BASE_URL}/saleBanner/update/${id}`,inputField, {
              ...
              setTimeout(() => {
                navigate('/admin/sale-bannerList')
              }, 1000);
      ...
      let singleBanner  = async (id) => {
        ...
        context.setProgress(30)
            ...
            try {
                let result = await axios.get(`${BASE_URL}/saleBanner/single/${id}`,inputField, {
                    withCredentials: true,
                    headers: {
                        "Content-Type": "multipart/form-data",
                    },
              ...
              context.setProgress(100)
            setSelectedBanner(result?.data?.banner?.imageUrl)
  ...
  return (
       <div className=" p-3">
         <div className="w-full flex justify-between p-5 rounded-lg bg-white">
              <div>
                <h3 className="text-xl font-semibold">Sale Banner Update</h3>
              </div>
...
export default UpdateSaleBanner