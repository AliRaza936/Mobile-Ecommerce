...
console.log(result.data)
      setInputField(result.data.accessory)
      if (result.data.accessory.images && result.data.accessory.images.length > 0) {
        setSelectedImage(result.data.accessory.images[0]); 
    }
      if (result.data.accessory.banner) {
        setSelectedBanner(result.data.accessory.banner); 
    }
  ...
  <div>
    <h3 className="text-xl xs:text-lg font-semibold">Edit Category</h3>
  </div>
