...
useEffect(() => {
 ...
 useEffect(() => {
  ...
  maxWidth="md"
      ...
      >
     <div onClick={(e) => e.stopPropagation()} className="pt-5 px-4 sm:px-5 w-full overflow-visible">
...
ProductPopup.propTypes = {
  closeViewProduct: PropTypes.func.isRequired, // Validate that closeViewProduct is a required function
};
